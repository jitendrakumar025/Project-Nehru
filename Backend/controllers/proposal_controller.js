...
exports.add_proposals=async(req,res)=>{
    try {
    const {intiated_by,purpose,detailed_justification,estimated_budget}=req.body
...
const proposal=new Proposals({
    intiated_by,purpose,detailed_justification,estimated_budget,user:req.user.id
})
...
exports.update_proposals=async(req,res)=>{
    ...
    if(intiated_by){newProposal.intiated_by=intiated_by}
