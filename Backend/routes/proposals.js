...
router.get('/fetchproposals',fetchuser,async(req,res)=>{
        try {
...
router.post('/addproposals',fetchuser,async(req,res)=>{
        try {
...
router.put('/updateproposals/:id',fetchuser,async(req,res)=>{
        try {
         const {purpose,detailed_justification,estimated_budget}=req.body
...
router.delete('/deleteproposals/:id',fetchuser,async(req,res)=>{
        try{
