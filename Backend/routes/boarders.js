...
router.get('/fetchboarders',fetchuser,async(req,res)=>{
        try {
...
router.post('/addboarders',fetchuser,async(req,res)=>{
        try {
...
//ROUTE:3 UPDATE BOARDER USING :PUT "/api/boarders/updateboarders"
router.put('/updateboarders/:id',fetchuser,async(req,res)=>{
        try {
...
//ROUTE:4 DELETE BOARDER DETAILS USING :DELETE "/api/boarders/deleteboarders"
router.delete('/deleteboarders/:id',fetchuser,async(req,res)=>{
        try{
